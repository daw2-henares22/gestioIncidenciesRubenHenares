...
const comentariosBd = [
  {
    usuario: "Javier Caraculo",
    fecha: "12/10/2022",
    comentario: "Este es un comentario Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit amet dignissimos laudantium blanditiis fuga recusandae sed culpa, earum pariatur repellat esse provident eaque totam quo sint iste, inventore deleniti quis."
  },
  {
    usuario: "Javier Caraculo",
    fecha: "12/10/2022",
...
const comentario = (nombre, fecha, comentario2) => {
  const template = `
    <div class="mt-4">
        <div class="card p-3">
            ${nombre}
